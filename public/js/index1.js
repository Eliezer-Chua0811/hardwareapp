...
let html = ``;
for(let i=0;i<this.item.length;i++){
if(this.item[i].name.toLowerCase().includes(txtSearchHard.value)||this.item[i].name.toUpperCase().includes(txtSearchHard.value)||this.item[i].description.toLowerCase().includes(txtSearchHard.value)){
html += `
<tr>
  <td><img src="${this.item[i].image}"id="imgre"></td>
  ...
  <div class="section">
    <div class="row">
      ...
      <div class="section" >
        ...
        <a class="waves-effect waves-light btn" onclick="component.updateHard(${val})">Done</a>
      </div>
...
<div class="section">
  ...
  <div class="section" id="section1">
    <p>This site is for people serching hardwares and computer components. Though, this site still needs improvement, we are working hard to progress and please our customers.
...
<footer class="page-footer green">
  <div class="row">
    ...
    <div class="col l3 s12">
     ...
     <li><a href="#"class="yellow-text hoverable">Contact</a></li>
   </ul>
 </div>
 <div class="col l3 s12">
  <img src="css/img/fblogo.png" class="hoverable"><a href="#" ></a><br>
  <img src="css/img/twitlogo.png"class="hoverable"><a href="#"></a><br>
  <img src="css/img/goologo.png"class="hoverable"><a href="#"></a><br>
</ul>
</div>
</div>
</footer> 
    ...
    <div class="row">
      <div id="readpage" class="row marketing">
        <div class="col s12 m12 l12">
          ...
          <a href="#!" class="waves-effect waves-light btn green" onclick="component.createHard()">Submit</a>
        </div>
      </div>          
    </div> 
    <footer class="page-footer green">
...
`;
this.reRender(`${html}`,document.getElementById('index1'));
$('#products').hide();
$('#homepage').show();
}
